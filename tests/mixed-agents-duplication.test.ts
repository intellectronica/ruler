...
`;
    ...
    const windsurfContent1 = await fs.readFile(windsurfPath, 'utf8');
    console.log('Windsurf content after apply:', windsurfContent1.substring(0, 200));
    ...
    const windsurfContent2 = await fs.readFile(windsurfPath, 'utf8');
    console.log('Windsurf content after 2nd apply:', windsurfContent2.substring(0, 200));
