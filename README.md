...
- **Primary File Order & Precedence**:
  ...
  3. Legacy `.ruler/instructions.md` (used as the primary file only if `.ruler/AGENTS.md` is absent; if both exist, `AGENTS.md` comes first and `instructions.md` is still concatenated later; no longer emits a deprecation warning)
