...
describe("Corrupted Generated Marker Fix", () => {
	...
	beforeEach(async () => {
		tempDir = await fs.mkdtemp(
			path.join(os.tmpdir(), "skiller-corrupted-marker-test-"),
		);
	});
...
.....`;
		...
		expect(originalContent).toMatch(/^<!-- Generated by Skiller -->/);
		...
		expect(corruptedFile).not.toContain("<!-- Generated by Skiller -->");
		expect(corruptedFile).toContain("<!-- Source: .claude/instructions.md -->"); // Still contains skiller sources
		...
		expect(fixedContent).toMatch(/^<!-- Generated by Skiller -->/);
...
.....`;
		...
		expect(windsurfContent).toContain("<!-- Generated by Skiller -->");
		expect(windsurfContent).toContain(
