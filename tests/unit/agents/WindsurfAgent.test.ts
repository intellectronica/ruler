...
describe('WindsurfAgent', () => {
  ...
  it('should apply skiller config to the default output path', async () => {
    ...
    expect(writeGeneratedFile).toHaveBeenCalledWith('/root/AGENTS.md', '<!-- Generated by Skiller -->\nrules');
  });
  ...
  it('should apply skiller config to a custom output path', async () => {
    ...
    expect(writeGeneratedFile).toHaveBeenCalledWith('/root/CUSTOM.md', '<!-- Generated by Skiller -->\nrules');
  });
});