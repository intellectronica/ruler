...
.....`;
    ...
    const windsurfContent = await fs.readFile(windsurfPath, 'utf8');
    ...
    // Should not include the corrupted AGENTS.md as a source
    expect(windsurfContent).not.toContain('<!-- Source: AGENTS.md -->');
